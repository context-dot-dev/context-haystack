...
class TestContextCrawler:
    ...
    def test_run_returns_only_successful_pages(self, request_context: MagicMock) -> None:
    ...
    @patch("haystack_integrations.components.fetchers.context.context_crawler.request_context")
    def test_run_defaults_to_one_page(self, request_context: MagicMock) -> None:
        request_context.return_value = CRAWL_RESPONSE
    ...
    @pytest.mark.asyncio
    async def test_run_async_crawls_concurrently(self, request_context: AsyncMock) -> None:
