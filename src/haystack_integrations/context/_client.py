...
DEFAULT_API_KEY = Secret.from_env_var(API_KEY_ENV_VAR)
...
USER_AGENT = f"context-dev-haystack/{_VERSION}"
...
def _query_value(name: str, value: object) -> list[tuple[str, str]]:
    if value is None:
        return []
